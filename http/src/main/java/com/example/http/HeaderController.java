...
public class HeaderController {
    ...
    // `header-one` 으로 들어온 HTTP 요청에 대하여 헤더 중 `xlikelion`이라는 헤더의 값을 인자로 전달받고 싶을 때
    ...
    // 헤더 중 x-likelion 이 있으면 할당, 없으면 null 값 받음
    ...
    // `header-type`으로 들어온 HTTP 요청에 대하여 헤더 중 x-likelion-int 가 있으면 Integer에 할당
...
//    }
    ...
    // 2. 동일한 헤더에 여러 값이 있을 때 리스트 형태로 출력됨
//    @PostMapping("/header-all")
//    public String getHeaderAll(@RequestHeader // 모든 헤더를 다 가져올 때
